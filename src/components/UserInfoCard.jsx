      ...
      <div>
        <div className=" flex flex-col text-gray-500 gap-4">
          <div className=" flex items-center gap-2">
            <span className=" text-black text-xl">Chidi Obialor</span>
            <span className=" text-sm">@chizzybaby</span>
          </div>
          <p>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo ab
            maxime natus, nulla autem fugit. Dolorum, provident tempore?
          </p>
          ...
          <div className=" flex gap-2">
            ...
            <div>
              Went to <b>Nigeria Navy Sec School</b>
            </div>
          </div>
