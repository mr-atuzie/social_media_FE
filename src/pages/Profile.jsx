          ...
          <>
            <div className=" flex-col  lg:gap-6 flex">
              <div className=" flex flex-col items-center justify-center">
                ...
                <h1 className=" mt-20 flex items-center gap-1  font-medium text-2xl">
                  {user?.username}{" "}
                  {user?.verified && (
                    <div>
                      <svg
            ...
            <div className=" p-4 shadow-md my-4 bg-white rounded-lg flex flex-col gap-3 lg:gap-6 lg:h-[200vh] lg:overflow-y-scroll customScrollBar">
              {posts?.map((post) => {
                return (
                  <Post
                    key={post?._id}
